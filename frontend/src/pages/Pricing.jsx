...
const PLANS = [
  {
    ...
    price: '₦25,000',
    period: '/month',
    description: 'Perfect for small MFIs getting started with credit data.',
    color: '#0ea5e9',
    features: [
      '100 statement analyses/month',
      '100 BVN verifications/month',
      '50 credit bureau checks/month',
      '1 API key',
      'Dashboard access',
      'Email support',
    ],
    notIncluded: ['Priority support', 'PDF reports', 'Webhook notifications', 'Custom integrations'],
    cta: 'Get Started',
    href: '/register',
    highlight: false,
  },
  {
    ...
    price: '₦75,000',
    period: '/month',
    description: 'For growing MFIs with higher loan volumes and team needs.',
    color: '#6d28d9',
    features: [
      '500 statement analyses/month',
      '500 BVN verifications/month',
      '250 credit bureau checks/month',
      '3 API keys',
      'Dashboard access',
      'PDF report exports',
  ...
  },
  {
    ...
    price: 'Custom',
    period: '',
    description: 'For large MFIs and financial institutions with bespoke needs.',
    color: '#0f172a',
    features: [
      'Unlimited statement analyses',
      'Unlimited BVN verifications',
      'Unlimited credit bureau checks',
      'Unlimited API keys',
      'Dashboard access',
      'PDF report exports',
      'Webhook notifications',
...
const FAQS = [
  { q: 'How are requests counted?', a: 'Each API call to an endpoint (statement analysis, BVN check, credit bureau) counts as one request. Failed requests due to upstream errors are not counted.' },
  { q: 'What happens if I exceed my limit?', a: 'Requests beyond your monthly limit will return a 429 error. You can upgrade your plan at any time to increase your limits.' },
  { q: 'Is there a free trial?', a: 'Yes — new MFIs get 10 free statement analyses upon registration to evaluate the platform before committing to a plan.' },
      ...
      <section style={s.compareSection}>
        <div style={s.plansInner}>
          ...
          <div style={s.compareTable}>
            ...
            {[
              ['Statement analyses/month', '100', '500', 'Unlimited'],
              ['BVN verifications/month', '100', '500', 'Unlimited'],
              ['Credit bureau checks/month', '50', '250', 'Unlimited'],
