...
export function exportLoanReviewPDF({ customer, review, loanParams }) {
  ...
  function addPage() {
    ...
    doc.text('Lucred — Loan Eligibility Review (CONFIDENTIAL)', 10, 8);
  ...
  doc.setFont('helvetica', 'italic');
  const disclaimer = 'This report is generated by the Lucred B2B Platform and is intended solely for the use of the MFI client to whom it is addressed. It constitutes algorithmic decision support only and does not constitute a binding credit assessment or financial advice. All lending decisions must comply with CBN guidelines and your institution\'s internal credit policy.';
